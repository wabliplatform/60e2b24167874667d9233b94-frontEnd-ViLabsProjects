...
(function(root, factory) {
  ...
  describe('Task', function() {
    ...
    it('should have the property tStart (base name: "tStart")', function() {
      // uncomment below and update the code to test the property tStart
      //var instance = new TempApi.Task();
      //expect(instance).to.be();
    });

    it('should have the property tEnd (base name: "tEnd")', function() {
      // uncomment below and update the code to test the property tEnd
      //var instance = new TempApi.Task();
      //expect(instance).to.be();
    });

    it('should have the property tPMs (base name: "tPMs")', function() {
      // uncomment below and update the code to test the property tPMs
      //var instance = new TempApi.Task();
      //expect(instance).to.be();
    });
